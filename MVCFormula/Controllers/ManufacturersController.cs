...
namespace MVCFormula.Controllers
{
    ...
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(MVCFormulaContext context, IHostingEnvironment hostingEnvironment)
        ...
        {
            var mvcFormulaContext = _context.Manufacturer.Include(m => m.Formulas);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var manufacturer = await _context.Manufacturer.Include(m=>m.Formulas).AsNoTracking()
        ...
        public async Task<IActionResult> FormulasByManufacturer(int? id)
        {
            if (id == null)
            {
                return NotFound();
            ...
            var manufacturer = await _context.Manufacturer.Include(m => m.Formulas)
                .FirstOrDefaultAsync(m => m.Id == id);
            if (manufacturer == null)
            {
                return NotFound();
